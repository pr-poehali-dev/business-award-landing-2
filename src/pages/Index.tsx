...
const juryPlaceholders = [
  ...
  {
    name: "Николай Предыбайло",
    role: "Предприниматель с 25-летним опытом. Владелец группы компаний «Мир кондиционеров» (г. Находка), инженерного центра «ТОПАС.Центр», а также строительно-производственной компании «Фабрика домов ТЕОН»",
    photo: "https://cdn.poehali.dev/projects/12e9a854-3fd5-400b-9c06-170c6e1dff34/bucket/6d0fe55c-14da-4d10-bbe3-b690aaca5987.jpg",
  },
];
